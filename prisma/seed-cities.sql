-- ===============================================================
-- SEED DATA: Lead Sources, Activity Types, Cities & Provinces
-- Upload langsung ke MySQL / MariaDB
-- ===============================================================

-- ─── SUMBER LEAD ──────────────────────────────────────────────
INSERT IGNORE INTO lead_sources (id, nama, isActive, createdAt) VALUES
('src_whatsapp',  'WhatsApp Admin',      1, NOW()),
('src_ig_dm',     'DM Instagram',        1, NOW()),
('src_tiktok_dm', 'DM TikTok',           1, NOW()),
('src_referral',  'Referral / Rekomendasi', 1, NOW()),
('src_website',   'Website / Landing Page', 1, NOW()),
('src_email',     'Email Marketing',     1, NOW()),
('src_event',     'Event / Pameran',     1, NOW()),
('src_tele',      'Telemarketing',       1, NOW()),
('src_walkin',    'Walk-in / Datang Langsung', 1, NOW()),
('src_lain',      'Lainnya',             1, NOW());
...
('kt_paritmalintang','Parit Malintang','Sumatera Barat'),
...
('kt_lomboktengah',  'Lombok Tengah',  'Nusa Tenggara Barat'),
('kt_lomboktimur',   'Lombok Timur',   'Nusa Tenggara Barat'),
('kt_lombokbarat',   'Lombok Barat',   'Nusa Tenggara Barat'),
...
('kt_ketapang',      'Ketapang',       'Kalimantan Barat'),
...
('kt_luwuk',         'Luwuk',          'Sulawesi Tengah'),
('kt_tolitoli',      'Tolitoli',       'Sulawesi Tengah'),

-- SULAWESI SELATAN
('kt_makassar',      'Makassar',       'Sulawesi Selatan'),
('kt_parepare',      'Parepare',       'Sulawesi Selatan'),
('kt_palopo',        'Palopo',         'Sulawesi Selatan'),
('kt_watampone',     'Watampone',      'Sulawesi Selatan'),
('kt_bulukumba',     'Bulukumba',      'Sulawesi Selatan'),
